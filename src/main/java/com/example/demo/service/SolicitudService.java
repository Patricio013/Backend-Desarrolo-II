...
public class SolicitudService {
    ...
    private static InvitacionCotizacionDTO buildInvitacionDTO(Solicitud s, Long rubroId, Prestador p, String mensajeBase) {
        return InvitacionCotizacionDTO.builder()
            ...
            .direccionProvincia(s.getDireccionProvincia())
            .direccionCiudad(s.getDireccionCiudad())
            .direccionCalle(s.getDireccionCalle())
            .direccionNumero(s.getDireccionNumero())
            .direccionPiso(s.getDireccionPiso())
            .direccionDepto(s.getDireccionDepto())
            .direccionCodigoPostal(s.getDireccionCodigoPostal())
