...
INSERT INTO solicitud (id, usuario_id, rubro_id, descripcion, estado,
  prestador_asignado_id, fue_cotizada, es_critica, created_at, updated_at) VALUES
  (1001, 1, 3, 'Pintar living y pasillo', 'CREADA', NULL, false, false, NOW(), NOW()),
  (1002, 2, 3, 'Pintura exterior de balcon', 'CREADA', NULL, false, false, NOW(), NOW()),
  (1003, 3, 2, 'Revision de cableado en cocina', 'CREADA', NULL, false, false, NOW(), NOW()),
  (1004, 4, 1, 'Cambio de sanitario en bano', 'CREADA', 1, false, false, NOW(), NOW())
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO solicitud (id, usuario_id, rubro_id, descripcion, estado,
  ...
  fue_cotizada, es_critica, created_at, updated_at)
VALUES
  (2001, 1, 1, 'Arreglo de caño cocina', 'ASIGNADA', 21, '2025-09-12', '09:00', '13:00', false, false, NOW(), NOW()),
  (2002, 2, 1, 'Cambio de inodoro', 'EN_PROGRESO', 21, '2025-09-12', '14:00', '18:00', false, false, NOW(), NOW())
ON CONFLICT (id) DO NOTHING;
INSERT INTO solicitud (id, usuario_id, rubro_id, descripcion, estado,
  prestador_asignado_id, preferencia_dia, preferencia_desde, preferencia_hasta,
  fue_cotizada, es_critica, created_at, updated_at)
VALUES
  (3001, 5, 1, 'Destapar caño del baño', 'CREADA', NULL,
   '2025-09-12', '09:00', '13:00', false, false, NOW(), NOW())
ON CONFLICT (id) DO NOTHING;
